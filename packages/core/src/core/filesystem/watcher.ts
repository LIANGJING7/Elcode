...
declare const LCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof LCODE_LIBC === "undefined" ? undefined : LCODE_LIBC
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.LCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.LCODE_EXPERIMENTAL_FILEWATCHER) {
