...
import { ToolFailure, toolText } from "@/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.LCODE_WEBSEARCH_PROVIDER === "exa" || process.env.LCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.LCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("LCODE_EXPERIMENTAL") || truthy("LCODE_ENABLE_EXA") || truthy("LCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("LCODE_ENABLE_PARALLEL") || truthy("LCODE_EXPERIMENTAL_PARALLEL"),
