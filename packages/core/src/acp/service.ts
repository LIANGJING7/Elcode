...
import type { Message, OpencodeClient, SessionMessageResponse } from "@/sdk/v2"
...
export function make(input: {
  ...
  const initialize = Effect.fn("ACP.initialize")(function* (params: InitializeRequest) {
    ...
    const authMethod: AuthMethod = {
      description: "Run `model-agent auth login` in the terminal",
      name: "Login with model-agent",
      id: AuthMethodID,
    }
