...
import defaultSoundPath from "@/ui/deps/assets/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@/ui/deps/assets/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@/ui/deps/assets/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@/ui/deps/assets/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@/ui/deps/assets/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@/ui/deps/assets/audio/yup-01.mp3" with { type: "file" }
