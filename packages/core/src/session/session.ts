import { PermissionV1 } from "@/core/v1/permission"
import { Slug } from "@/core/util/slug"
import { SessionV1 } from "@/core/v1/session"
import { serviceUse } from "@/core/effect/service-use"
import path from "path"
import { BackgroundJob } from "@/background/job"
import { Decimal } from "decimal.js"
import type { ProviderMetadata, Usage } from "@/llm"
...
import { SessionV2 } from "@/core/session"
import { SessionExecution } from "@/core/session/execution"
...
import { PartTable, SessionTable } from "@/core/session/sql"
import { ProjectTable } from "@/core/project/sql"
import { MessageV2 } from "./message-v2"
import type { InstanceContext } from "../project/instance-context"
import { InstanceState } from "@/effect/instance-state"
import { Snapshot } from "@/snapshot"
import { ProjectV2 } from "@/core/project"
import { WorkspaceV2 } from "@/core/workspace"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".lcode", "plans")
