...
import { EventSequenceTable, EventTable } from "@/core/event/sql"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        LCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        LCODE_WORKSPACE_ID: config.id,
        LCODE_EXPERIMENTAL_WORKSPACES: "true",
