...
export const TypeId: TypeId = "~@/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@/effect-sqlite-node/NodeSqliteClient")
