...
import { ProjectDirectoryTable, ProjectTable } from "@/core/project/sql"
import { SessionTable } from "@/core/session/sql"
import { WorkspaceTable } from "@/core/control-plane/workspace.sql"
import { Flag } from "@/core/flag/flag"
import { GlobalBus } from "@/bus/global"
import { which } from "@/core/util/which"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.LCODE_FAKE_VCS)
