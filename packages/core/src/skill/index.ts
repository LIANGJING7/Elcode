...
import { SkillPlugin } from "@/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@/core/v1/config/error"
...
const LCODE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const CUSTOMIZE_LCODE_SKILL_NAME = "customize-opencode"
const CUSTOMIZE_LCODE_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating opencode's own configuration: opencode.json, opencode.jsonc, files under .opencode/, or files under ~/.config/opencode/. Also use when creating or fixing opencode agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring opencode itself."
const CUSTOMIZE_LCODE_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, LCODE_SKILL_PATTERN)
  }
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_LCODE_SKILL_NAME] = {
          name: CUSTOMIZE_LCODE_SKILL_NAME,
