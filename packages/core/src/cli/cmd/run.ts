import type { PermissionV1 } from "@/core/v1/permission"
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@/sdk/v2"
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("password", {
        alias: ["p"],
        type: "string",
        describe: "basic auth password (defaults to LCODE_SERVER_PASSWORD)",
      })
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to LCODE_SERVER_USERNAME or 'opencode')",
      })
      .option("dir", {
        type: "string",
